...
| `GAIA_VERSION` | No | `0.15.1` | PyPI version to install (override image default) |
...
- `itomek/gaia-linux:0.15.1` - Installs GAIA 0.15.1
- `itomek/gaia-linux:0.15.2` - Installs GAIA 0.15.2
- etc.
